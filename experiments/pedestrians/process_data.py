...
sys.path.append("/home/choi/social-nce-trajectron-plus-plus/trajectron")
...
nl = 0
l = 0
maybe_makedirs('/home/choi/social-nce-trajectron-plus-plus/experiments/processed')
data_columns = pd.MultiIndex.from_product([['position', 'velocity', 'acceleration'], ['x', 'y']])
for desired_source in ['eth', 'hotel', 'univ', 'zara1', 'zara2']:
    for data_class in ['train', 'val', 'test']:
        ...
        scenes = []
        data_dict_path = os.path.join('/home/choi/social-nce-trajectron-plus-plus/experiments/processed', '_'.join([desired_source, data_class]) + '.pkl')
