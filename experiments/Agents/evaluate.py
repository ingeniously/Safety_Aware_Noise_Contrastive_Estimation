...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        # Note: the inference of the Trajectron++ is conditioned on the states of neighboring PEDESTRIANs up to the observation time, but not on any steps that have already been predicted about the future. This design makes the model unaware of the latest states of the nearby PEDESTRIANs and causes high collision rate at long horizon. As such, our evaluation of collision rate is focused on the first four prediction steps where the models still have access to relatively up-to-date information of the surrounding neighbors.
